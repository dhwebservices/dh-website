    ...
    <main style={{ paddingTop:'var(--nav-h)' }}>
      ...
      {SVCS.map((s,i)=>(
        <div key={s.num} className="reveal" style={{ borderTop:'1px solid var(--border-light)' }}>
          <div className="container" style={{ padding:'clamp(36px,4vw,52px) clamp(20px,5vw,60px)', display:'grid', gridTemplateColumns:'72px 1fr 1fr', gap:'clamp(24px,4vw,48px)', alignItems:'start' }}>
