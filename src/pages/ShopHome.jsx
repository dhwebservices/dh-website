...
export default function ShopHome() {
  ...
  return (
    <main style={{ paddingTop: 'calc(var(--nav-h) + 48px)' }}>
        ...
        >
          <div style={{ display: 'grid', gap: 20 }}>
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              <h1 style={{ fontSize: 'clamp(34px, 5vw, 58px)', lineHeight: 0.96, letterSpacing: '-0.06em', fontWeight: 600 }}>
                Phones, tablets and laptops in one catalogue.
              </h1>
              <p style={{ maxWidth: 620, fontSize: 16, lineHeight: 1.7, color: 'var(--mid)' }}>
      ...
      <section style={{ padding: '0 max(24px, 50vw - 580px) 44px' }}>
