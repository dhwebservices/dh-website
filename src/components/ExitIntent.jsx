        ...
        <div style={{ padding: '36px 36px 32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 20 }}>
            ...
            <a href="https://wa.me/447359587007?text=Hi%2C%20I%20have%20a%20quick%20question%20about%20your%20services" target="_blank" rel="noreferrer" onClick={dismiss}
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '12px 20px', borderRadius: 100, background: '#075E54', color: '#fff', textDecoration: 'none', fontSize: 14, fontWeight: 600, transition: 'opacity 0.15s' }}
              onMouseOver={e => e.currentTarget.style.opacity = '0.88'}
              onMouseOut={e => e.currentTarget.style.opacity = '1'}>
